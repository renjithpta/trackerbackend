package com.ust.userweb.persistence.specification;
...
import com.ust.userwebapp.persistence.model.Principal_;
import com.ust.userwebapp.persistence.model.Privilege;
import com.ust.userwebapp.persistence.model.Privilege_;
import com.ust.userwebapp.persistence.model.Role;
import com.ust.userwebapp.persistence.model.Role_;
...
public final class QuerySpecification {
	  ...
	  private QuerySpecification() {
	    ...
	    private static Specification<Principal> userByNameEq(final String name, final boolean negated) {
	        return QuerySpecification.<Principal> entityByKeyEq(name, negated, Principal_.name);
	    }

	    private static Specification<Principal> userByNameContains(final String name, final boolean negated) {
	        return QuerySpecification.<Principal> entityByKeyContains(name, negated, Principal_.name);
	    }

	    private static Specification<Principal> userByNameStartsWith(final String name, final boolean negated) {
	        return QuerySpecification.<Principal> entityByKeyStartsWith(name, negated, Principal_.name);
	    }

	    private static Specification<Principal> userByNameEndsWith(final String name, final boolean negated) {
	        return QuerySpecification.<Principal> entityByKeyEndsWith(name, negated, Principal_.name);
	    }
	    ...
	    private static Specification<Role> roleByNameEq(final String name, final boolean negated) {
	        return QuerySpecification.<Role> entityByKeyEq(name, negated, Role_.name);
	    }

	    private static Specification<Role> roleByNameContains(final String name, final boolean negated) {
	        return QuerySpecification.<Role> entityByKeyContains(name, negated, Role_.name);
	    }

	    private static Specification<Role> roleByNameEndsWith(final String name, final boolean negated) {
	        return QuerySpecification.<Role> entityByKeyEndsWith(name, negated, Role_.name);
	    }

	    private static Specification<Role> roleByNameStartsWith(final String name, final boolean negated) {
	        return QuerySpecification.<Role> entityByKeyStartsWith(name, negated, Role_.name);
	    }
