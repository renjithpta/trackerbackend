...
@ComponentScan({ "com.ust.userwebapp.persistence.model" })
@PropertySource({ "classpath:persistence-${persistenceTarget:h2}.properties" })
@EnableJpaRepositories(basePackages = "com.ust.userwebapp.persistence.dao")
public class UmPersistenceJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.ust.userwebapp.persistence.model" });
