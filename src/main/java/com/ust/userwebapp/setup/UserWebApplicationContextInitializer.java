...
public class UserWebApplicationContextInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public UserWebApplicationContextInitializer() {
        super();
    }
