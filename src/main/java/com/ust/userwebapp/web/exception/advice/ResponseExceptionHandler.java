package com.ust.userwebapp.web.exception.advice;
...
import com.ust.userwebapp.web.exception.bean.ValidationErrorDTO;
@ControllerAdvice
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler {
	 private Logger log = LoggerFactory.getLogger(getClass());
	    ...
	    @ExceptionHandler({ EntityNotFoundException.class,  UserWebAppResourceNotFoundException.class })
	    ...
	    @ExceptionHandler({ InvalidDataAccessApiUsageException.class, DataAccessException.class,UserWebAppConflictException.class })
